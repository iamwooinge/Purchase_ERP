   ...
   ResultSet rs = null;
		...
		if (check != null){ //체크박스 값 넘어가는지 콘솔 출력 확인용
		 ...
		 // 페이지 나누기
	      ...
	      int pagesize = 5; // 한 페이지에 보이는 정보 10개씩
	      ...
	      PreparedStatement pstmt_page = conn_page.prepareStatement("select count(*) from claim");
...
function pagingSetColor() {
   ...
   <div class="wrap">
        <ui class="naviMenu">
            <li class="navi" id="claim_menu">
                <a href="#claim_menu" class="menuBtn">청구</a>
                <div class="subMenu">
            ...
            <li class="navi" id="order_menu">
                <a href="#order_menu" class="menuBtn">발주</a>
                <div class="subMenu">
            ...
            <li class="navi" id="income_menu">
                <a href="#income_menu" class="menuBtn">입고</a>
                <div class="subMenu">
            ...
            <li class="navi" id="stock_menu">
                <a href="#stock_menu" class="menuBtn">재고</a>
                <div class="subMenu">
 ...
 <!-- 테이블 코드  -->
	...
	<div>
		<form method="post" action="manage_billing.jsp">
			<div class="search">
				<input type="checkbox" name="condition" value="일자">&nbsp;일자 : &nbsp;<input type = "date" name = "start_set_mb" class="search_input"> - <input type = "date" name = "end_set_mb" class="search_input">&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="condition" value="담당자" >&nbsp;담당자 : &nbsp;<input type="text" name="manager" class="search_input">
				&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="condition" value="품명">&nbsp;품명 : &nbsp;  
		...
		<div class="content_receiving">
    	<div class="container">
    	<div class="table-responsive">  
		<table id = "mb_table" class="table custom-table">
		<thead>
				<tr>
						...
						<th id = "mb_td" class="table_th" scope="col" align="center">진행상태</th>
			...
			while(true){
						...
						<td align="center"><%=rs.getString("claim_date")%></td> <!--청구일자-->
                  		...
                  		<%if(rs.getString("claim_state").equals("미접수")){ %>
                  			<td align="center" style=color:red;><%=rs.getString("claim_state")%></td> <!--진행상태-->
                  		<%}else if(rs.getString("claim_state").equals("접수")){ %>
                  			<td align="center" style=color:blue;><%=rs.getString("claim_state")%></td> <!--진행상태-->
                  		<%} %>
                  </tr>
						<%	if(!rs.next()) break;  }%>
			</tbody>
  ...
  <%
   startpage = currentpage - ((currentpage-1) % limit);
    ...
    if(startpage-limit>0){
     ...
     %>
     <a href = "http://localhost:8080/purchase_ERP/manage_billing.jsp?currentpage=<%=currentpage%>">〈</a>
     <%} 
   ...
   %>
    <a id="num<%=i %>" href = "http://localhost:8080/purchase_ERP/manage_billing.jsp?currentpage=<%=i%>"><%=i %></a>
   <%
	...
	function openChild(){
	      ...
	      // window.name = "부모창 이름"; 
	       ...
	       openWin = window.open("application_form.jsp",
	               "child", "width=924, height=1110, top=250, left=500");
